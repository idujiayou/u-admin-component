...
// NAMESPACE OBJECT: ./src/utils/validator.js
var validator_namespaceObject = {};
__webpack_require__.r(validator_namespaceObject);
__webpack_require__.d(validator_namespaceObject, "isPassword", function() { return isPassword; });
...
var validator_lang = lang["c" /* locale */][Object(lang["a" /* getLanguage */])(lang["c" /* locale */])] || {};
var isPassword = /*#__PURE__*/function () {
  var _ref = Object(asyncToGenerator["a" /* default */])( /*#__PURE__*/regeneratorRuntime.mark(function _callee(rule, value) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", Promise.reject(Object(lang["b" /* getLocaleValue */])(validator_lang, 'uValidator.isPassword')));
  ...
  return function isPassword(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
isPassword.message = Object(lang["b" /* getLocaleValue */])(validator_lang, 'uValidator.isPassword');
// CONCATENATED MODULE: ./src/config.js


/* harmony default export */ var config = __webpack_exports__["default"] = ({
  validator: validator_namespaceObject,
  upload: {
    action: 'http://rap2api.taobao.org/app/mock/266394/upload',
    requestFormat: function requestFormat(file) {
      ...
      demo: {
        request: function request(query) {
          ...
          for (var i = 0; i < query.pageSize; i++) {
            var id = i + 1 + (query.page - 1) * query.pageSize;
            rows.push({
              id: id,
              name: 'name' + id,
              age: id + 10,
  ...
  Api: {
    response: {
      ...
      getCode: function getCode(response) {
        return response.code;
      },
      isSuccess: function isSuccess(response) {
        return response.code + '' === '200';
      },
      getPageTotal: function getPageTotal(response) {
        return response.data.total;
      },
      // 列表
      getRowsData: function getRowsData(response) {
